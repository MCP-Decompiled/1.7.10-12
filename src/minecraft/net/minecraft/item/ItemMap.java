...
public class ItemMap extends ItemMapBase
{
    ...
    public MapData getMapData(ItemStack p_77873_1_, World p_77873_2_)
    {
        ...
        if (var4 == null && !p_77873_2_.isRemote)
        {
    ...
    public Packet createMapDataPacket(ItemStack p_150911_1_, World p_150911_2_, EntityPlayer p_150911_3_)
    {
        ...
        return var4 == null ? null : new S34PacketMaps(p_150911_1_.getMetadata(), var4);
    }
    ...
    public void onCreated(ItemStack p_77622_1_, World p_77622_2_, EntityPlayer p_77622_3_)
    {
        if (p_77622_1_.hasTagCompound() && p_77622_1_.getTagCompound().getBoolean("map_is_scaling"))
        {
            ...
            MapData var5 = new MapData("map_" + p_77622_1_.getMetadata());
            ...
            var5.markDirty();
            p_77622_2_.setItemData("map_" + p_77622_1_.getMetadata(), var5);
        }
    }
