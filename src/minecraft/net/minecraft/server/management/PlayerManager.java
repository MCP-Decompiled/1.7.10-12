    ...
    class PlayerInstance
    {
        ...
        public void onUpdate()
        {
            if (this.numBlocksToUpdate != 0)
            {
                ...
                {
                    var1 = this.currentChunk.chunkXPos * 16 + (this.locationOfBlockChange[0] >> 12 & 15);
                    var2 = this.locationOfBlockChange[0] & 255;
                    var3 = this.currentChunk.chunkZPos * 16 + (this.locationOfBlockChange[0] >> 8 & 15);
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        {
                            var2 = this.currentChunk.chunkXPos * 16 + (this.locationOfBlockChange[var1] >> 12 & 15);
                            var3 = this.locationOfBlockChange[var1] & 255;
                            var4 = this.currentChunk.chunkZPos * 16 + (this.locationOfBlockChange[var1] >> 8 & 15);
