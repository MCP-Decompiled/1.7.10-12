    ...
    public void updateRepairOutput()
    {
        ...
        else
        {
            ...
            if (var6 != null)
            {
                ...
                {
                    var9 = Math.min(var5.getCurrentDurability(), var5.getMaxDurability() / 4);
                    ...
                    {
                        var11 = var5.getCurrentDurability() - var9;
                        var5.setMetadata(var11);
                        var2 += Math.max(1, var9 / 100) + var7.size();
                        var9 = Math.min(var5.getCurrentDurability(), var5.getMaxDurability() / 4);
                    }

                    this.materialCost = var10;
                }
                else
                {
                    ...
                    {
                        var9 = var1.getMaxDurability() - var1.getCurrentDurability();
                        var10 = var6.getMaxDurability() - var6.getCurrentDurability();
                        var11 = var10 + var5.getMaxDurability() * 12 / 100;
                        int var12 = var9 + var11;
                        var13 = var5.getMaxDurability() - var12;
