    ...
    public ItemStack slotClick(int slotId, int clickedButton, int mode, EntityPlayer player)
    {
        ...
        else
        {
            ...
            if ((mode == 0 || mode == 1) && (clickedButton == 0 || clickedButton == 1))
            {
                if (slotId == -999)
                {
                    if (var6.getItemStack() != null && slotId == -999)
                    {
                        if (clickedButton == 0)
                        {
            ...
            else if (mode == 3 && player.capabilities.isCreativeMode && var6.getItemStack() == null && slotId >= 0)
            {
                var16 = (Slot)this.inventorySlots.get(slotId);
    ...
    protected boolean mergeItemStack(ItemStack p_75135_1_, int p_75135_2_, int p_75135_3_, boolean p_75135_4_)
    {
        ...
        if (p_75135_1_.isStackable())
        {
            while (p_75135_1_.stackSize > 0 && (!p_75135_4_ && var6 < p_75135_3_ || p_75135_4_ && var6 >= p_75135_2_))
            {
                ...
                if (var8 != null && var8.getItem() == p_75135_1_.getItem() && (!p_75135_1_.getHasSubtypes() || p_75135_1_.getMetadata() == var8.getMetadata()) && ItemStack.areItemStackTagsEqual(p_75135_1_, var8))
                {
