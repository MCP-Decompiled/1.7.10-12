...
public class PathFinder
{
    ...
    private int findPathOptions(Entity p_75860_1_, PathPoint p_75860_2_, PathPoint p_75860_3_, PathPoint p_75860_4_, float p_75860_5_)
    {
        ...
        if (var8 != null && !var8.visited && var8.distanceTo(p_75860_4_) < p_75860_5_)
        {
            this.pathOptions[var6++] = var8;
        }

        if (var9 != null && !var9.visited && var9.distanceTo(p_75860_4_) < p_75860_5_)
        {
            this.pathOptions[var6++] = var9;
        }

        if (var10 != null && !var10.visited && var10.distanceTo(p_75860_4_) < p_75860_5_)
        {
            this.pathOptions[var6++] = var10;
        }

        if (var11 != null && !var11.visited && var11.distanceTo(p_75860_4_) < p_75860_5_)
        {
    ...
    {
        PathPoint var7 = null;
        int var8 = this.canEntityStandAt(p_75858_1_, p_75858_2_, p_75858_3_, p_75858_4_, p_75858_5_);
        ...
        else
        {
            ...
            if (var7 == null && p_75858_6_ > 0 && var8 != -3 && var8 != -4 && this.canEntityStandAt(p_75858_1_, p_75858_2_, p_75858_3_ + p_75858_6_, p_75858_4_, p_75858_5_) == 1)
            {
            ...
            if (var7 != null)
            {
                ...
                while (p_75858_3_ > 0)
                {
                    var10 = this.canEntityStandAt(p_75858_1_, p_75858_2_, p_75858_3_ - 1, p_75858_4_, p_75858_5_);

                    if (this.avoidsWater && var10 == -1)
                    {
                        return null;
                    }
                    ...
                    if (var9++ >= p_75858_1_.getMaxFallHeight())
                    {
                        return null;
                    }
            ...
            for (int var10 = p_82565_2_; var10 < p_82565_2_ + p_82565_4_.yCoord; ++var10)
            {
                for (int var11 = p_82565_3_; var11 < p_82565_3_ + p_82565_4_.zCoord; ++var11)
                {
                    ...
                    if (var12.getMaterial() != Material.air)
                    {
                        ...
                        else if (!var12.isPassable(p_82565_0_.worldObj, var9, var10, var11) && (!p_82565_6_ || var12 != Blocks.wooden_door))
                        {
