...
public class CommandSpreadPlayers extends CommandBase
{
    ...
    public void processCommand(ICommandSender sender, String[] args)
    {
        ...
        else
        {
            ...
            double var8 = parseDouble(sender, args[var16++], 0.0D);
            double var10 = parseDouble(sender, args[var16++], var8 + 1.0D);
            ...
            while (true)
            {
                ...
                sender.addChatMessage(new ChatComponentTranslation("commands.spreadplayers.spreading." + (var12 ? "teams" : "players"), new Object[] {Integer.valueOf(var13.size()), Double.valueOf(var10), Double.valueOf(var4), Double.valueOf(var6), Double.valueOf(var8)}));
