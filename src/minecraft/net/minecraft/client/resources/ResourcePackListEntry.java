...
public abstract class ResourcePackListEntry implements GuiListExtended.IGuiListEntry
{
    ...
    public void drawEntry(int p_148279_1_, int p_148279_2_, int p_148279_3_, int p_148279_4_, int p_148279_5_, Tessellator p_148279_6_, int p_148279_7_, int p_148279_8_, boolean p_148279_9_)
    {
        ...
        var11 = this.field_148317_a.fontRendererObj.getStringWidth(var14);

        if (var11 > 157)
        {
            var14 = this.field_148317_a.fontRendererObj.trimStringToWidth(var14, 157 - this.field_148317_a.fontRendererObj.getStringWidth("...")) + "...";
        }

        this.field_148317_a.fontRendererObj.drawStringWithShadow(var14, p_148279_2_ + 32 + 2, p_148279_3_ + 1, 16777215);
        List var12 = this.field_148317_a.fontRendererObj.listFormattedStringToWidth(this.func_148311_a(), 157);

        for (int var13 = 0; var13 < 2 && var13 < var12.size(); ++var13)
        {
            this.field_148317_a.fontRendererObj.drawStringWithShadow((String)var12.get(var13), p_148279_2_ + 32 + 2, p_148279_3_ + 12 + 10 * var13, 8421504);
        }
    }
