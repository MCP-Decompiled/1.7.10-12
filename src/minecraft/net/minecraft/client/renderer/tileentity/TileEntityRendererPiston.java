...
public class TileEntityRendererPiston extends TileEntitySpecialRenderer
{
    ...
    {
        Block var9 = p_147500_1_.getStoredBlockID();
        ...
        if (var9.getMaterial() != Material.air && p_147500_1_.func_145860_a(p_147500_8_) < 1.0F)
        {
            ...
            var10.setTranslation((double)((float)p_147500_2_ - (float)p_147500_1_.xCoord + p_147500_1_.func_145865_b(p_147500_8_)), (double)((float)p_147500_4_ - (float)p_147500_1_.yCoord + p_147500_1_.func_145862_c(p_147500_8_)), (double)((float)p_147500_6_ - (float)p_147500_1_.zCoord + p_147500_1_.func_145859_d(p_147500_8_)));
            var10.setColorOpaque_F(1.0F, 1.0F, 1.0F);

            if (var9 == Blocks.piston_head && p_147500_1_.func_145860_a(p_147500_8_) < 0.5F)
            {
                this.field_147516_b.renderPistonExtensionAllFaces(var9, p_147500_1_.xCoord, p_147500_1_.yCoord, p_147500_1_.zCoord, false);
            }
            else if (p_147500_1_.shouldPistonHeadBeRendered() && !p_147500_1_.isExtending())
            {
                ...
                var10.setTranslation((double)((float)p_147500_2_ - (float)p_147500_1_.xCoord), (double)((float)p_147500_4_ - (float)p_147500_1_.yCoord), (double)((float)p_147500_6_ - (float)p_147500_1_.zCoord));
                this.field_147516_b.renderPistonBaseAllFaces(var9, p_147500_1_.xCoord, p_147500_1_.yCoord, p_147500_1_.zCoord);
            }
            else
            {
                this.field_147516_b.renderBlockAllFaces(var9, p_147500_1_.xCoord, p_147500_1_.yCoord, p_147500_1_.zCoord);
            }
