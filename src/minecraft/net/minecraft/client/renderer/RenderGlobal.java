...
public class RenderGlobal implements IWorldAccess
{
    ...
    public void renderEntities(EntityLivingBase p_147589_1_, ICamera p_147589_2_, float p_147589_3_)
    {
        ...
        else
        {
            ...
            {
                TileEntityRendererDispatcher.instance.renderTileEntity((TileEntity)this.tileEntities.get(var18), p_147589_3_);
            }
    ...
    public void playRecord(String p_72702_1_, int p_72702_2_, int p_72702_3_, int p_72702_4_)
    {
        ...
        if (p_72702_1_ != null)
        {
            ItemRecord var7 = ItemRecord.getRecord(p_72702_1_);
            ...
            PositionedSoundRecord var8 = PositionedSoundRecord.createRecordSoundAtPosition(new ResourceLocation(p_72702_1_), (float)p_72702_2_, (float)p_72702_3_, (float)p_72702_4_);
    ...
    public void playAuxSFX(EntityPlayer p_72706_1_, int p_72706_2_, int p_72706_3_, int p_72706_4_, int p_72706_5_, int p_72706_6_)
    {
        ...
        switch (p_72706_2_)
        {
            ...
            case 2001:
                ...
                {
                    this.mc.getSoundHandler().playSound(new PositionedSoundRecord(new ResourceLocation(var8.stepSound.getDigResourcePath()), (var8.stepSound.getVolume() + 1.0F) / 2.0F, var8.stepSound.getFrequency() * 0.8F, (float)p_72706_3_ + 0.5F, (float)p_72706_4_ + 0.5F, (float)p_72706_5_ + 0.5F));
                }

                this.mc.effectRenderer.addBlockDestroyEffects(p_72706_3_, p_72706_4_, p_72706_5_, var8, p_72706_6_ >> 12 & 255);
                break;
