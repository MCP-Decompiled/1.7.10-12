...
public class RenderItem extends Render
{
        ...
        if (var10.getItem() != null)
        {
            ...
            if (var10.getItemSpriteNumber() == 0 && var10.getItem() instanceof ItemBlock && RenderBlocks.renderItemIn3d(Block.getBlockFromItem(var10.getItem()).getRenderType()))
            {
                ...
                for (int var26 = 0; var26 < var13; ++var26)
                {
                    ...
                    this.renderBlocksRi.renderBlockAsItem(var22, var10.getMetadata(), 1.0F);
                    GL11.glPopMatrix();
                }
            ...
            else
            {
                ...
                if (var10.getItemSpriteNumber() == 1 && var10.getItem().requiresMultipleRenderPasses())
                {
                    ...
                    {
                        this.random.setSeed(187L);
                        IIcon var23 = var10.getItem().getIconFromDamageForRenderPass(var10.getMetadata(), var21);
    ...
    {
        int var6 = p_77015_3_.getMetadata();
    ...
    public void renderItemOverlayIntoGUI(FontRenderer p_94148_1_, TextureManager p_94148_2_, ItemStack p_94148_3_, int p_94148_4_, int p_94148_5_, String p_94148_6_)
    {
        if (p_94148_3_ != null)
        {
            ...
            {
                int var12 = (int)Math.round(13.0D - (double)p_94148_3_.getCurrentDurability() * 13.0D / (double)p_94148_3_.getMaxDurability());
                int var8 = (int)Math.round(255.0D - (double)p_94148_3_.getCurrentDurability() * 255.0D / (double)p_94148_3_.getMaxDurability());
                GL11.glDisable(GL11.GL_LIGHTING);
                GL11.glDisable(GL11.GL_DEPTH_TEST);
                GL11.glDisable(GL11.GL_TEXTURE_2D);
                GL11.glDisable(GL11.GL_ALPHA_TEST);
