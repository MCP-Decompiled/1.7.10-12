...
public class GuiIngestServers extends GuiScreen
{
    ...
    class ServerList extends GuiSlot
    {
        ...
        {
            IngestServer var8 = GuiIngestServers.this.mc.getTwitchStream().func_152925_v()[p_148126_1_];
            String var9 = var8.serverUrl.replaceAll("\\{stream_key\\}", "");
            String var10 = (int)var8.bitrateKbps + " kbps";
            String var11 = null;
            IngestServerTester var12 = GuiIngestServers.this.mc.getTwitchStream().func_152932_y();
            ...
            GuiIngestServers.this.drawString(GuiIngestServers.this.fontRendererObj, var10, this.getScrollBarX() - 5 - GuiIngestServers.this.fontRendererObj.getStringWidth(var10), p_148126_3_ + 5, 8421504);

            if (var11 != null)
            {
                GuiIngestServers.this.drawString(GuiIngestServers.this.fontRendererObj, var11, this.getScrollBarX() - 5 - GuiIngestServers.this.fontRendererObj.getStringWidth(var11), p_148126_3_ + 5 + 3 + GuiIngestServers.this.fontRendererObj.FONT_HEIGHT, 8421504);
            }
        }
