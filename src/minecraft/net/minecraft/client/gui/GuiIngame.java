...
public class GuiIngame extends Gui
{
    ...
    private void renderInventorySlot(int p_73832_1_, int p_73832_2_, int p_73832_3_, float p_73832_4_)
    {
        ...
        if (var5 != null)
        {
            ...
            itemRenderer.renderItemAndEffectIntoGUI(this.mc.fontRendererObj, this.mc.getTextureManager(), var5, p_73832_2_, p_73832_3_);
            ...
            itemRenderer.renderItemOverlayIntoGUI(this.mc.fontRendererObj, this.mc.getTextureManager(), var5, p_73832_2_, p_73832_3_);
        }
    }
