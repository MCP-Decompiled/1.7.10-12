...
public class InventoryPlayer implements IInventory
{
    ...
    public int clearInventory(Item p_146027_1_, int p_146027_2_)
    {
        ...
        for (var4 = 0; var4 < this.mainInventory.length; ++var4)
        {
            ...
            if (var5 != null && (p_146027_1_ == null || var5.getItem() == p_146027_1_) && (p_146027_2_ <= -1 || var5.getMetadata() == p_146027_2_))
            {
                var3 += var5.stackSize;
    ...
    public boolean func_146025_b(Block p_146025_1_)
    {
        ...
        else
        {
            ...
            return var2 != null ? var2.canItemHarvestBlock(p_146025_1_) : false;
        }
    }
