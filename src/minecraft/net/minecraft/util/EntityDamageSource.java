...
public class EntityDamageSource extends DamageSource
{
    ...
    public IChatComponent getDeathMessage(EntityLivingBase p_151519_1_)
    {
        ...
        return var2 != null && var2.hasDisplayName() && StatCollector.canTranslate(var4) ? new ChatComponentTranslation(var4, new Object[] {p_151519_1_.getFormattedCommandSenderName(), this.damageSourceEntity.getFormattedCommandSenderName(), var2.func_151000_E()}): new ChatComponentTranslation(var3, new Object[] {p_151519_1_.getFormattedCommandSenderName(), this.damageSourceEntity.getFormattedCommandSenderName()});
    }
