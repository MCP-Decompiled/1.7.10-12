...
public class WeightedRandomFishable extends WeightedRandom.Item
{
    ...
    public ItemStack getItemStack(Random p_150708_1_)
    {
        ...
        {
            int var3 = (int)(this.maxDamagePercent * (float)this.returnStack.getMaxDurability());
            int var4 = var2.getMaxDurability() - p_150708_1_.nextInt(p_150708_1_.nextInt(var3) + 1);
