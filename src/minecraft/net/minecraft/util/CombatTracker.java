            ...
            if (var1 != null && var2.getDamageSrc() == DamageSource.fall)
            {
                ...
                if (var1.getDamageSrc() != DamageSource.fall && var1.getDamageSrc() != DamageSource.outOfWorld)
                {
                    if (var6 != null && (var4 == null || !var6.equals(var4)))
                    {
                        ...
                        {
                            var3 = new ChatComponentTranslation("death.fell.assist.item", new Object[] {this.fighter.getFormattedCommandSenderName(), var6, var8.func_151000_E()});
                        }
                        else
                        {
                            var3 = new ChatComponentTranslation("death.fell.assist", new Object[] {this.fighter.getFormattedCommandSenderName(), var6});
                        }
                    }
                    else if (var4 != null)
                    {
                        ...
                        {
                            var3 = new ChatComponentTranslation("death.fell.finish.item", new Object[] {this.fighter.getFormattedCommandSenderName(), var4, var7.func_151000_E()});
                        }
                        else
                        {
                            var3 = new ChatComponentTranslation("death.fell.finish", new Object[] {this.fighter.getFormattedCommandSenderName(), var4});
                        }
                    }
                    else
                    {
                        var3 = new ChatComponentTranslation("death.fell.killer", new Object[] {this.fighter.getFormattedCommandSenderName()});
                    }
                }
                else
                {
                    var3 = new ChatComponentTranslation("death.fell.accident." + this.func_94548_b(var1), new Object[] {this.fighter.getFormattedCommandSenderName()});
                }
            }
            else
            {
